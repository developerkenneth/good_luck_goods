...
export default function Cart() {
  ...
  return (
    <>
      <SEO
        title="Your Cart – Goodlucks Goods"
        description="Review the items in your cart before checkout. Fast and secure online shopping at Goodlucks Goods."
        keywords="shopping cart, goodlucks goods cart"
        url="https://shop.goodlucks.co/cart"
      />
